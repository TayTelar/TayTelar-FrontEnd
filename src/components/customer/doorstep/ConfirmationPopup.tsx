...
const ConfirmationPopup: React.FC<PopupProps> = ({ date, slot, onClose }) => {
    ...
    <div className="overlay">
      <div className="content">
        ...
        <p className="third__text">
          Our team will arrive at your home on {date} at {slot} for your
          Alteration appointment. Reach out to our customer support in Home Page
          for any inquiries.
        </p>
