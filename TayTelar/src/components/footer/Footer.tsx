            ...
            <div className="footer_container">
                <div className="footer_container_section">
                    ...
                    <div className="footer_section4">
                        <h4>Contact Info</h4>
                        <p><HeadsetMicOutlinedIcon />&nbsp;&nbsp;+1-2355-3345-5 <br /> &nbsp;&nbsp;contact@logiscocorp.com</p>
                        <h4>Find Us</h4>
                        <p>
                            <LocationOnOutlinedIcon />  &nbsp;&nbsp;Box 3233 <br /> &nbsp;&nbsp;1810 Kings Way King Street,<br /> &nbsp;&nbsp;5th Avenue, New York
                        </p>
                    </div>
                </div>
            </div>
            <div className="footer_bottom">
                <div className="footer_bottom_container">
                    ...
                    <div className="footer_bottom_right">
                        <img src={pementlogo} alt="pementlogo" />
                    </div>
                </div>
            </div>
        </footer>
