            ...
            <div className="contact_details">
              ...
              <div className="details">
                <div className="email">
                  ...
                  <p>
                    <a href="mailto: info@seabed2crest.com" className="content">
                ...
                <div className="phone">
                  ...
                  <p>
                    <a href="tel:+91 7979699428" className="content">+91 7979699428</a>
                  </p>
                </div>
                ...
                <div className="social_media">
                  <h3>Follow us On</h3>
                  <a href="https://www.facebook.com/profile.php?id=61553225352683" target="_blank" rel="noopener noreferrer">
                    <i className="fa-brands fa-facebook fa-2xl"></i>
                  </a>
                  <a href="https://www.linkedin.com/in/nandu-bus-2755622aa/" target="_blank" rel="noopener noreferrer">
                    <i className="fa-brands fa-linkedin fa-2xl"></i>
                  </a>
                  <a href="https://twitter.com/NanduBus" target="_blank" rel="noopener noreferrer">
                    <i className="fa-brands fa-x-twitter fa-2xl"></i>
                  </a>
                  <a href="https://www.instagram.com/nandu_bus/" target="_blank" rel="noopener noreferrer">
